    ...
    <div>
        ...
        <div className='flex flex-col items-center sm:grid grid-cols-4 gap-4 p-[40px] text-[14px]'>
            {paisFiltrado.map((pais: any) => (
                ...
                <div className='dark:bg-[var(--cards)] dark:shadow-black hover:shadow-lg hover:translate-y-[-1px] hover:transition-all hover:duration-150 bg-[#ece6e1] shadow-md rounded-[5px]'>
                    <img src={pais.flags.png} className='rounded-t-[5px] w-[100%]'/>
                    <div>
                        <ul className='p-[20px]'>
                        <li className='lg:text-[24px] p-[3px] font-black text-[20px] '>{pais.name}</li>
